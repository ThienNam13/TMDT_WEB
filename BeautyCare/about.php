...
<ul>
    <li><strong>Chất lượng:</strong> Chúng tôi chỉ cung cấp các sản phẩm có nguồn gốc rõ ràng, được kiểm định chất lượng nghiêm ngặt.</li>
    <li><strong>Tận tâm:</strong> Đội ngũ nhân viên chuyên nghiệp, nhiệt tình, luôn sẵn sàng lắng nghe và tư vấn để khách hàng tìm được sản phẩm phù hợp nhất.</li>
    <li><strong>Uy tín:</strong> Lấy sự hài lòng của khách hàng làm thước đo thành công. Chúng tôi luôn minh bạch trong mọi chính sách và hoạt động.</li>
</ul>
