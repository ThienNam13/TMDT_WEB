...
<div style="height: 1000px; background-color: #f0f4f8; text-align: center; padding-top: 50px;">
    <h1>Nội dung trang web của bạn</h1>
    <p>Cuộn xuống để xem footer.</p>
</div>
...
<footer class="site-footer">
    <div class="footer-container">
        <div class="footer-section">
            ...
            <p><strong>Địa chỉ:</strong> 6 Phan Đăng Lưu, P. Bình Thạnh, TP.HCM</p>
